...
import numpy as np
import os
# this is mainly for case118 and only this
...
# # 使用示例
# file_path = '/mnt/afs/data/Samples_v5/case118/caseN_5/IEEE118,case0,FL5.txt'
# matrix_bus_df, matrix_branch_df = parse_txt_file(file_path)

# print("\nMatrix Bus DataFrame:")
# print(matrix_bus_df)
# print("\nMatrix Branch DataFrame:")
# print(matrix_branch_df)
...
for i in range(case_nums):
    ...
    #     store_matrix_bus = matrix_bus_df.to_numpy
    # else:
    #     store_matrix_bus = np.stack((store_matrix_bus, matrix_bus_df.to_numpy), axis=-1)
    # if not store_matrix_branch:
    #     store_matrix_branch = matrix_branch_df.to_numpy
    # else:
    #     store_matrix_branch = np.stack((store_matrix_branch, matrix_branch_df.to_numpy), axis=-1)
    if not store_matrix_bus:
    ...
    # print("\nMatrix Branch DataFrame:")
    # print(matrix_branch_df)
# print(store_matrix_bus)


np.save('./case118us_node_features.npy', np.array(store_matrix_bus))
np.save('./case118us_edge_features.npy',np.array(store_matrix_branch))
